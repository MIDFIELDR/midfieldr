...
**R ecosystem**. Internally, midfieldr and midfielddata use a data.table syntax and structure. Thus data frames returned by midfieldr functions and the practice data sets are of class "data.frame" and  "data.table."
