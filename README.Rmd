...
obs_cip <- 1584 #unpack_data(bit = "obs_cip")
var_cip <- 6 #unpack_data(bit = "var_cip")
size_cip <- 364 # unpack_data(bit = "size_cip", power10 = 3)

obs_students <- 97640 # unpack_data(bit = "obs_students")
var_students <- 15 #unpack_data(bit = "var_students")
size_students <- 19 #unpack_data(bit = "size_students", power10 = 6)

year_min <- 1987 #unpack_data(bit = "year_min")
year_max <- 2016 # unpack_data(bit = "year_max")

obs_degrees <- 97640 #unpack_data(bit = "obs_degrees")
var_degrees <- 5 # unpack_data(bit = "var_degrees")
size_degrees <- 10 # unpack_data(bit = "size_degrees", power10 = 6)

obs_terms <- 729104 # unpack_data(bit = "obs_terms")
var_terms <- 13 # unpack_data(bit = "var_terms")
size_terms <- 82 # unpack_data(bit = "size_terms", power10 = 6)

obs_courses <- 3.5 # unpack_data(bit = "obs_courses", power10 = 6, decimals = 1)
var_courses <- 12 # unpack_data(bit = "var_courses")
size_courses <- 348 # unpack_data(bit = "size_courses", power10 = 6)
```
...
Install midfielddata from our drat repo. The data package is large, so this step takes time. Be patient and wait for the Console prompt > to reappear.
...
A short but complete example is provided in the [Getting started](articles/getting_started.html) vignette. 
