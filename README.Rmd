...
source("vignettes/vignette-knitr-opts.R")
...
- `feasible_subset()` subset students for 6-year completion feasibility
...
**example**. The *Get started* vignette [(link)](get_started.html) introduces some of the basic midfieldr functions and the midfielddata data sets. Additional vignettes develop the material in more detail.  
