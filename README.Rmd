...
**midfieldr** is an R package that provides tools for working with MIDFIELD research data and with the practice data in the midfielddata R package. 
...
Tabulated results of usage example. "Timely completion" is the count of graduates completing their programs in no more than 6 years; "Late completion" is the count of those graduating in more than 6 years; "Did not complete" is the count of non-graduates. 
...
![midfieldr help page](man/figures/README-midfieldr-help-page-1.png){width="75%"}
...
![midfielddata help page](man/figures/README-midfielddata-help-page-1.png){width="75%"}
