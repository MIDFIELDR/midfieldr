...
```{r}
#| include: false
completion_status <- c(rep(NA_character_, 12), rep("late", 12), rep("timely", 12))
people <- rep(c("Asian Female", "Asian Male", "Black Female", "Black Male", "Hispanic Female", "Hispanic Male", "International Female", "International Male", "Native American Female", "Native American Male", "White Female", "White Male"), 3)
N <- c(43, 163, 39, 84, 31, 102, 51, 280, 2, 6, 386, 2034, 4, 19, 3, 5, 3, 19, 9, 41, 0, 3, 51, 269, 87, 315, 26, 80, 36, 181, 110, 501, 2, 13, 985, 4100)
DT_display <- data.table(completion_status, people, N)
DT_display <- DT_display[N != 0]
```
