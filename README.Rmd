...
- `filter_degree_seeking()` limit the study to degree-seeking students 
- `add_term_timely()` estimate the latest term for which program completion could be considered timely 
- `add_data_sufficient()` determine if data have sufficient span to fairly assess a student's record 
