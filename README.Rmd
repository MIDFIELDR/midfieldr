...
Package not yet submitted to CRAN. The development version can be installed from GitHub using:

```r
install.packages("devtools")
devtools::install_github("MIDFIELDR/midfieldr")
```
midfieldr depends on the midfielddata package in a [drat repository](https://midfieldr.github.io/drat/) on GitHub. To use midfieldr, you will need to install midfielddata. 
