...
term[order(-before_or_after), .N, by = "before_or_after"]
course[order(-before_or_after), .N, by = "before_or_after"]
degree[order(-before_or_after), .N, by = "before_or_after"]

# Retain before terms
term <- term[before_or_after == "before"]
course <- course[before_or_after == "before"]
