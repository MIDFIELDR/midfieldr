...
<!-- Add to DESCRIPTION -->
<!-- Remotes: MIDFIELDR/midfielddata -->
...
To use midfieldr, the  [midfielddata](https://midfieldr.github.io/midfielddata) package should also be installed. 

Not yet submitted to CRAN, but development versions can be downloaded from GitHub.  
...
For additional midfieldr functionality and metrics see the [vignettes](articles/index.html).  
