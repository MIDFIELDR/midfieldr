...
**data carpentry** The default data frame structure is `data.table`. A user who prefers a dplyr or strictly base R ecosystem should find the translation to be straightforward. midfieldr functions attempt to preserve data frame extensions such as tibble.   
...
temp_ids <- completion_feasible(id = enrollees$id)
