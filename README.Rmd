...
Provides tools and demonstrates methods for working with individual undergraduate student-level records (registrar's data) in R.

- `filter_cip()` selects rows of program codes that match search terms
- `select_required()` selects a minimum set of columns required by midfieldr functions
...
- `add_completion_status()` adds a new program completion status variable
