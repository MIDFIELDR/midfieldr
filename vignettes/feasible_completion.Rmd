...
`completion_feasible()` is used to subset a set of student IDs to retain those students for whom program completion is feasible. In this vignette we explore its arguments and continue the ongoing case study in four engineering programs. 
