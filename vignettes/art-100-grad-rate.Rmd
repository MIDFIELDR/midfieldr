...
*Starters.* &nbsp; The summary code chunk from [Starters](art-070-starters.html)
...
*Graduates* &nbsp; The summary code chunk from [Graduates](art-080-graduates.html)
...
*Order factors.* &nbsp; Order the levels of the categories. Code adapted from [Multiway data and charts](art-120-multiway.html). 
...
*Multiway chart.* &nbsp; Code adapted from [Multiway data and charts](art-120-multiway.html). 
...
*Results table.* &nbsp; Code adapted from [Multiway data and charts](art-120-multiway.html).
