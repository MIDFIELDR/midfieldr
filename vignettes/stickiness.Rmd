...
By previously ordering the factor levels, we have structured the data so that the rows and panels of the multiway graph are ordered by the appropriate medians. We use conventional ggplot2 functions applied to the `stickiness` data frame: 
