...
Optionally, we can select just the variables we want to work with next. `select_se()` is an [seplyr](https://winvector.github.io/seplyr/) function. 

```{r}
students <- students %>%
  select_se(., c("program", "race", "sex")) %>%
  glimpse()
```
