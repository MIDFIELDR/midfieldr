...
Instructional programs are encoded in `cip`, a midfieldr data frame of character variables listing the 2, 4, and 6-digit CIP codes and program names in the MIDFILED database. To learn more, open the help page by running `?cip`. 
