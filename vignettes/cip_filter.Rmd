...
`cip_filter()` is compatible with the pipe operator `%>%`. Thus a previously filtered CIP data frame is the `data` argument for the subsequent operation. For example: 

```{r results = "hide"}
# filtering sequentially
df <- cip_filter(series = "History") %>%
