...
In spite of its flaws, graduation rate is a widely used persistence metric. We provide functionality to compute graduation rate with an option to use the IPEDS definition or the less-restrictive MIDFIELD definition that includes more students. 
