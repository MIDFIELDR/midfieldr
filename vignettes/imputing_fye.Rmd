---
title: "Imputing starting majors for FYE students"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Imputing starting majors for FYE students}
...
```{r echo=FALSE}
# for session_info
package_string <- "dplyr|knitr|midfieldr|midfielddata|seplyr|stringr|mice|visdat"
```
