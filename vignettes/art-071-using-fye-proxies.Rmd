...
Part 2 of a development in two parts for working with engineering programs  illustrating our treatment of First-Year Engineering (FYE) programs when counting starters. Users working exclusively with either non-engineering programs or engineering at non-FYE institutions can disregard this vignette. 
...
2. Using FYE proxies (this page). Incorporating a set of prepared FYE proxies with other first-term CIP codes to construct a data frame of starters. Suitable for multi-institutional (FYE and non-FYE) studies. 
