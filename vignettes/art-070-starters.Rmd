...
In two special cases, an entering student's CIP code does not correspond to a degree-granting program. The first case includes records for which a CIP is unspecified or reported as "undecided". In MIDFIELD data, both conditions are encoded as CIP 999999. Students may *enter* with this CIP but we do not consider them *starters* until and if they enroll in a degree-granting  program. 
...
Our procedure for identifying starters accommodate both special cases.
