...
One additional special case should be mentioned. Gathering a bloc of starters for the conventional graduation rate metric entails more constraints---and  therefore excludes more students---than the procedure developed here. Details are given in [Graduation rate](art-100-grad-rate.html).   
...
*Filter.*  &nbsp; Because "starter" usually means "starter in specific programs," this bloc concludes with a filter by program. Code adapted from [Groupings](art-090-groupings.html#program-labels). 
