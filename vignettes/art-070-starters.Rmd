...
*Loads with midfieldr.* &nbsp; Prepared data. View data dictionaries via `?study_programs`, `?fye_proxy`. 
...
*Verify prepared data.* &nbsp; `study_starters`, included with midfieldr, contains the case study information developed above. Here we verify that the two data frames have the same content.  
