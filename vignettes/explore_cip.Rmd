...
`get_cip()` is used to search for the CIP codes of programs one wishes to study. In this vignette we explore its arguments and we collect the codes for a case study of four engineering programs used in subsequent vignettes. 
...
Programs in the US are encoded by "CIP" codes. CIP is the acronym for *Classification of Instructional Programs*, a taxonomy of academic programs curated by the US Department of Education [@NCES:2010].  
