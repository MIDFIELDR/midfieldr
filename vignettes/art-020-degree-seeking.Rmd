...
Using data.table syntax, we demonstrate inner joins to add columns from midfielddata tables to a working data frame and filter for matching rows. 

Filtering for degree seeking is typical in MIDFIELD research because non-degree-seeking students are of little interest in most studies.  
