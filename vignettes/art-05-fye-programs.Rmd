...
knitr::opts_chunk$set(fig.path = "../man/figures/art-05-fye-programs-")
...
FYE programs are problematic for some persistence metrics. The IPEDS "graduation rate" metric, for example, defines successful graduation as students graduating (within 6 years) from the same program in which they matriculate. An FYE student cannot satisfy this requirement. 
...
## Using prepared imputation values 
...
# rows_we_want <- midfieldstudents$id %in% study_id
...
## Performing a multiple imputation 
