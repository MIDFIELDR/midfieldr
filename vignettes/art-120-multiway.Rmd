...
y <- order_multiway(DT, "stick", c("program", "people"), method = "median")

# Using the implicit default for method
z <- order_multiway(DT, "stick", c("program", "people"))
...
For example, the results show that the stickiness of Civil Engineering (`program_stick`) is `r unique(DT_ratio[program == "Civil", (program_stick)])`%, and of Asian Females, `r unique(DT_ratio[people == "Asian Female", (people_stick)])`% (`people_stick`). We confirm these results by computing the group stickiness values independently. 
...
tbl[, results := paste0("\u0028", ever, "\u0029", "\u00A0", round(stick, 1), "%") ]
tbl
```
