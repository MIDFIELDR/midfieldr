...
The [Gather program data](gather_program_data.html) vignette describes how to obtain the program codes and names for these programs. Their  6-digit CIP codes and names are in the midfieldr data set `exa_programs`. 
