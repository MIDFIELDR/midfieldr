...
- Examine the data set variables and structure
- Condition the data for a multiway display 
- Graph the graduation rate in both forms shown above 
...
- Examine the data set variables and structure
- Reshape the data to construct a table like the one above 
