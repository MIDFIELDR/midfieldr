...
### Option 2. Named series value >>>>> delete
...
If using CIP data from another source, your data might have a layout   different from the `cip` data set. To operate on your data using midfieldr, you will have to first rearrange your data and rename the variables so that the number and type of columns match those of `cip`. 

As a reminder, `glimpse()` shows the basic structure of `cip`. 
