...
- For more practice using `cip_filter()`, see the vignette [Exploring program CIP codes](explore_cip.html).  
...
`exa_programs`, a data set identical to the `program_group` data frame above, is bundled in midfieldr for use in subsequent vignettes and example. 
