...
To filter by program, we have to construct a data frame of labels for our four engineering programs keyed by the US *Classification of Instructional Programs* (CIP) codes. These codes are included with midfieldr in the `cip` data set. 
...
This data frame is included with midfieldr as the `study_programs` data set. You can view the help page by running
...
These IDs are included with midfieldr as the `study_mcid` data set. You can view the help page by running
...
**Write to file.**  Results like these, used as inputs for calculating summary statistics and metrics, are often written to file as an intermediate result. In this case, the data frame above is included with midfieldr as `study_observations`. You can view the help page (and data dictionary) by running
