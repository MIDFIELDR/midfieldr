...
Starting with the `student`, `term`, and `degree` data tables, we filtered the data for data sufficiency, degree seeking, program, and timely completion in four programs (Civil, Electrical, Industrial/Systems, and Mechanical Engineering) and 
processed the data to obtain the observations needed to determine stickiness.  
