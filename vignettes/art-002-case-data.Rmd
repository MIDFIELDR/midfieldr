...
**Joining.** Having checked that the new abbreviations correctly represent the programs, we join the program names to the working data frame using a left-outer join and return selected rows.    
