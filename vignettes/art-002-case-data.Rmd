...
Starting with the `student`, `term`, and `degree` data tables, we processed the data to obtain the observations needed to determine stickiness.  


**Write to file.**  Results like these, used as inputs for calculating summary statistics and metrics, are often written to file as an intermediate result. In this case, the data frame above is bundled with midfieldr as `study_observations`. 
