---
title: "Selecting programs"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Selecting programs}
...
## midfieldr case data includes `case_cip_group`  

```{r echo = FALSE, eval = FALSE}
# case_cip_group <- cip_group
# devtools::use_data(
# 	case_cip_group,
# 	pkg = ".",
# 	internal  = FALSE,
...
For convenience, both ours and yours, this data frame of engineering CIP codes and program names has been saved as a midfieldr data set. We use this case data  in several vignettes.  
