...
knitr::opts_chunk$set(fig.path = "figures/art-110-")
...
```{r child = paste0(path_to_rmd, "/define-ever-enrolled.Rmd")}
```
...
[&#9665; Graduation rate](art-100-grad-rate.html) &nbsp;&nbsp; <a href="#top">&#9650; top of page</a> &nbsp;&nbsp; [Multiway data and charts &#9655;](art-120-multiway.html) 
