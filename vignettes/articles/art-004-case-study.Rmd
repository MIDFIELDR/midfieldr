...
We are not generally interested in terms beyond the first degree term, so we identify and exclude terms later than the first degree term in all the source data frames. Here, we retrieve the source tables that have term variables. 
