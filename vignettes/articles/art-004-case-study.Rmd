...
`filter_cip_rows()` searches `dframe` for string patterns. Searching for "civil engineering"  yields programs in Engineering that we want and some in Engineering Technology that we do not. 
