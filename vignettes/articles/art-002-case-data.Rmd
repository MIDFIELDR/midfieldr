...
knitr::opts_chunk$set(fig.path = "figures/art-002-")
...
```{r child = paste0(path_to_rmd, "/define-inner-join.Rmd")}
```
...
*Verify prepared data.* &nbsp; `baseline_mcid`, included with midfieldr, contains the case study information developed above. Here we verify that the two data frames have the same content. 
...
```{r child = paste0(path_to_rmd, "/define-left-join.Rmd")}
```
...
```{r child = paste0(path_to_rmd, "/define-grouping-variables.Rmd")}
```
...
[&#9665; Case study goals](art-001-case-goals.html) &nbsp; <a href="#top">&#9650; top of page</a> &nbsp;[Case study results &#9655;](art-003-case-results.html) 
