...
knitr::opts_chunk$set(fig.path = "figures/art-070-")
...
```{r child = paste0(path_to_rmd, "/define-undecided.Rmd")}
```
...
*Filter.* &nbsp; Order rows by ID and term, then filter to retain the start term observation(s). The `.SD[term == min(term)]` retains multiple rows for the same ID just in case a student is enrolled in more than one program in their first term. 
...
[&#9665; FYE proxies](art-060-fye-proxies.html) &nbsp;&nbsp; <a href="#top">&#9650; top of page</a> &nbsp;&nbsp; [Graduates &#9655;](art-080-graduates.html) 
