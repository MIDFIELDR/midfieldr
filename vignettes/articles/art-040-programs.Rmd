...
library("midfieldr")
df <- filter_programs(cip, "^41")
n41 <- nrow(df)
n4102 <- nrow(filter_programs(df, "^4102"))
n4103 <- nrow(filter_programs(df, "^4103"))
name41 <- unique(df[, cip2name])

df24 <- filter_programs(cip, "^24")
n24 <- nrow(df24)
name24 <- unique(df24[, cip2name])

df51 <- filter_programs(cip, "^51")
n51 <- nrow(df51)
name51 <- unique(df51[, cip2name])

df1313 <- filter_programs(cip, "^1313")
n1313 <- nrow(df1313)
...
Filtering the CIP data for all programs containing the word "engineering" yields `r nrow(filter_programs(cip, "engineering"))` observations. 
