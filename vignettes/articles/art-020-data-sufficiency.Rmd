...
```{r}
#| include: false
knitr::opts_chunk$set(fig.path = "img/art-020-")
```
...
![Figure 1: Upper limit data sufficiency](img/art-020-data-sufficiency-upper.png){width="100%"}
...
![Figure 2: Lower limit data sufficiency](img/art-020-data-sufficiency-lower.png){width="100%"}
