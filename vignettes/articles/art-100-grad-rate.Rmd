...
knitr::opts_chunk$set(fig.path = "figures/art-100-")
...
```{r child = paste0(path_to_rmd, "/define-graduation-rate.Rmd")}
```
\[
G=\frac{N_{sg}}{N_s}
\]
...
[&#9665; Groupings](art-090-groupings.html) &nbsp;&nbsp; <a href="#top">&#9650; top of page</a> &nbsp;&nbsp; [Stickiness &#9655;](art-110-stickiness.html) 
