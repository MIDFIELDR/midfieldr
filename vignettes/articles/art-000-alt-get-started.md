...
<div id="qsfqbdyrlk" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#qsfqbdyrlk table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}
&#10;#qsfqbdyrlk thead, #qsfqbdyrlk tbody, #qsfqbdyrlk tfoot, #qsfqbdyrlk tr, #qsfqbdyrlk td, #qsfqbdyrlk th {
  border-style: none;
}
&#10;#qsfqbdyrlk p {
  margin: 0;
...
&#10;#qsfqbdyrlk .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #5F5F5F;
}
&#10;#qsfqbdyrlk .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
&#10;#qsfqbdyrlk .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
&#10;#qsfqbdyrlk .gt_column_spanner_outer:first-child {
  padding-left: 0;
}
&#10;#qsfqbdyrlk .gt_column_spanner_outer:last-child {
  padding-right: 0;
}
&#10;#qsfqbdyrlk .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #5F5F5F;
  vertical-align: bottom;
...
&#10;#qsfqbdyrlk .gt_spanner_row {
  border-bottom-style: hidden;
}
&#10;#qsfqbdyrlk .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
&#10;#qsfqbdyrlk .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
&#10;#qsfqbdyrlk .gt_from_md > :first-child {
  margin-top: 0;
}
&#10;#qsfqbdyrlk .gt_from_md > :last-child {
  margin-bottom: 0;
}
&#10;#qsfqbdyrlk .gt_row {
  padding-top: 8px;
...
&#10;#qsfqbdyrlk .gt_row_group_first td {
  border-top-width: 2px;
}
&#10;#qsfqbdyrlk .gt_row_group_first th {
  border-top-width: 2px;
}
&#10;#qsfqbdyrlk .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
&#10;#qsfqbdyrlk .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #5F5F5F;
}
&#10;#qsfqbdyrlk .gt_first_summary_row.thick {
  border-top-width: 2px;
}
&#10;#qsfqbdyrlk .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
&#10;#qsfqbdyrlk .gt_grand_summary_row {
  color: #333333;
...
&#10;#qsfqbdyrlk .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
&#10;#qsfqbdyrlk .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
&#10;#qsfqbdyrlk .gt_striped {
  background-color: #F4F4F4;
}
&#10;#qsfqbdyrlk .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #5F5F5F;
  border-bottom-style: solid;
...
&#10;#qsfqbdyrlk .gt_font_normal {
  font-weight: normal;
}
&#10;#qsfqbdyrlk .gt_font_bold {
  font-weight: bold;
}
&#10;#qsfqbdyrlk .gt_font_italic {
  font-style: italic;
}
&#10;#qsfqbdyrlk .gt_super {
  font-size: 65%;
}
&#10;#qsfqbdyrlk .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}
&#10;#qsfqbdyrlk .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}
&#10;#qsfqbdyrlk .gt_indent_1 {
  text-indent: 5px;
}
&#10;#qsfqbdyrlk .gt_indent_2 {
  text-indent: 10px;
}
&#10;#qsfqbdyrlk .gt_indent_3 {
  text-indent: 15px;
}
&#10;#qsfqbdyrlk .gt_indent_4 {
  text-indent: 20px;
}
&#10;#qsfqbdyrlk .gt_indent_5 {
  text-indent: 25px;
}
&#10;#qsfqbdyrlk .katex-display {
  display: inline-flex !important;
  margin-bottom: 0.75em !important;
}
&#10;#qsfqbdyrlk div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
...
`?degree`. If you are new to these data, the best place to start is the
...
# restore data.table structure before continuing
setDT(student)
```
...
with midfieldr. See [Alternative CIPs](art-041-alternative-cip.html) for
details. `look_at()` is a midfieldr utility function that wraps
`base::str()` for a cleaner-looking output.
...
We can organize midfieldr functions based on their contribution to the
workflow.
...
Before operating on student records, we `data.table::copy()` the
...
`add_post_bacc()` identifies post-baccalaureate terms so a user can
exclude them from a data frame. To do so, the input data frame must have
a term variable with one of three possible names: `term` (from the term
table), `term_course` (course table), or `term_degree` (degree table).
...
that error message, we can use our `catch_error()` utility,
...
We can use another utility, `sort_uniq()`, to display the unique values
...
course, term, degree—to file as a baseline set of records as a basis for
...
`filter_cip()` acts on the `cip` data frame to select rows that match or
partially match search strings. Search strings are case-independent and
...
*Baseline programs.*   This concludes the outline for developing
baseline programs. Again, we would probably write the result to file to
use as needed in the next stages of analysis. The 6-digit codes are used
for joining operations and the labels are used as grouping variables.
...
their program completion would be considered timely. The result is used
to refine the population to meet the constraints of data sufficiency and
timely completion.
...
`add_timely_term()` adds a column for the timely completion term plus
additional columns of supporting information: the student’s initial
term; their academic level upon entry; and the span in years, adjusted
by their starting level, that defines timely completion for each student
(default is 6 years). Adjusted spans range from 3 years (a transfer
student entering with 3 years worth of credit) to 6 years (a typical
first-year student).
...
`add_data_sufficiency()` identifies student IDs whose records—near the
upper and lower bounds of an institution’s data range—must be excluded
to prevent false counts due to insufficient data.
...
*Baseline population.*   This concludes the procedure for developing the
initial baseline population for a study. As usual, we would probably
write the result to file as a common starting point for further
analysis.
...
bloc of graduates, not as part of the baseline population.

We start with the baseline population, add the timely completion term,
retain the minimum set of columns, and apply `add_completion_status()`.
...
`prep_fye_mice()` is used when blocs of starters in Engineering are
required. It conditions data for imputing starting majors of First-Year
Engineering (FYE) students. For details see [FYE
proxies](art-060-fye-proxies.html).

`order_multiway()` conditions data for Cleveland multiway charts. For
details see [Multiway data and charts](art-120-multiway.html).
