...
wrapr::build_frame(
  "Dataset", "Each row is", "N students", "N rows", "N columns", "Memory" |
    "course",  "one student per term & course", 
               "97,555",    "3,289,532", 12L, "324.3 MB" |
    "term",    "one student per term", 
               "97,555",      "639,915", 13L,  "72.8 MB" |
    "student", "one student", 
               "97,555",       "97,555", 13L,  "17.3 MB" |
    "degree",  "one student per degree", 
               "49,543",       "49,665", 5L,    "5.2 MB"
) |>
  gt() |>
...
```{r child = paste0(path_to_rmd, "/define-observation-variable.Rmd")}
```
...
```{r child = paste0(path_to_rmd, "/note-for-practice-only-1.Rmd")}
```
