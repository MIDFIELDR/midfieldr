...
Columns are added indicating an institution's data range and the results of the data sufficiency test: "satisfied" if the time span from entry to timely completion lie within the range; "fail" if not. We typically include the "satisfied" rows only. 
...
We filter to retain rows labeled "satisfied". The resulting IDs define our baseline population. 
