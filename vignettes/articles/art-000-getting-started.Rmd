...
- `undergraduate_terms()`  &nbsp; identifies rows with post-baccalaureate terms to exclude.  
...
- `undergraduate_terms()` identifies post-baccalaureate terms to exclude.
...
`undergraduate_terms()` identifies terms later than the first baccalaureate, if any.  
...
`undergraduate_terms()` adds a column indicating the group a term belongs to with respect to the first degree term.
...
We filter to exclude all terms labeled "graduate" and drop the temporary columns. 
