...
knitr::opts_chunk$set(fig.path = "figures/art-010-")
...
```{r child = paste0(path_to_rmd, "/note-midfielddata-and-midfield.Rmd")}
```
...
[&#9665; Case study results](art-003-case-results.html) &nbsp;&nbsp; <a href="#top">&#9650; top of page</a> &nbsp;&nbsp; [Data sufficiency &#9655;](art-020-data-sufficiency.html) 
