...
*Filtering.* To preserve the anonymity of the people involved, we remove observations with fewer than $N$ observations. When dealing with the full MIDFIELD research data, we typically use $N = 10$, but for these practice data, we use $N = 3$. 
