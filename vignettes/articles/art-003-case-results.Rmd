---
title: "Case study part 3: Results"
format:
  gfm:
...
knitr::opts_chunk$set(fig.path = "figures/art-003-")
...
```{r child = paste0(path_to_rmd, "/define-metric.Rmd")}
```
...
*Filtering.* To preserve the anonymity of the people involved, we remove observations with fewer than $\small N$ observations. When dealing with the full MIDFIELD research data, we typically use $\small N = 10$, but for these practice data, we use $\small N = 3$. 
...
#| label: fig02
#| fig-asp: 0.9
#| fig-cap: "Figure 2: Stickiness with programs in panels."
...
[&#9665; Case study data](art-002-case-data.html) &nbsp; <a href="#top">&#9650; top of page</a> &nbsp;[Planning a workflow &#9655;](art-010-planning.html) 
