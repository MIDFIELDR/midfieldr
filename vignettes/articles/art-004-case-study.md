...
[here](articles/art-005-case-dplyr.html).
...
and the counts by group $\small N_\textrm{grad}$ and
$\small N_\textrm{ever}$.
...
“civil engineering” yields programs in Engineering that we want and some
in Engineering Technology that we do not.
...
`post_bacc_terms()` accesses the `degree` table to do its work. If
`degree` is in the environment, the following lines yield identical
results:
...
the key or composite key variables of the data tables. The optional
`type` argument refines the column selection.

``` r
student <- select_records(student, type = "s") # type "s" for student
term <- select_records(term, "t")              # type "t" for term
degree <- select_records(degree, "d")          # type "d" for degree
```

`look_at()` is a midfieldr convenience function that wraps
`base::str()`.
...
`post_bacc_terms()` adds a column of labels indicating that a term
belongs to one of three clusters: terms that are prior to, equal to, or
subsequent to the student’s first degree term.
...
`timely_term()` adds a column of timely completion terms, encoded YYYYT.
...
`data_sufficiency()` adds a column of labels indicating that a student
ID should be included (or excluded) because for that student, the
institution’s data range satisfies (or does not satisfy) the data
...
`completion_status()` adds a column of labels indicating that program
completion was timely, late, or NA (for non-completers).
...
with $\small N$ or fewer observations. When dealing with the full
MIDFIELD research data, we typically use $\small N = 10$, but for these
practice data we illustrate the procedure using $\small N = 3$.
...
<div id="gactpqlxev" style="padding-left:0px;padding-right:0px;padding-top:10px;padding-bottom:10px;overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
<style>#gactpqlxev table {
  font-family: system-ui, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji';
  -webkit-font-smoothing: antialiased;
  -moz-osx-font-smoothing: grayscale;
}
&#10;#gactpqlxev thead, #gactpqlxev tbody, #gactpqlxev tfoot, #gactpqlxev tr, #gactpqlxev td, #gactpqlxev th {
  border-style: none;
}
&#10;#gactpqlxev p {
  margin: 0;
...
&#10;#gactpqlxev .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #5F5F5F;
}
&#10;#gactpqlxev .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
&#10;#gactpqlxev .gt_column_spanner_outer {
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
  font-weight: normal;
...
&#10;#gactpqlxev .gt_column_spanner_outer:first-child {
  padding-left: 0;
}
&#10;#gactpqlxev .gt_column_spanner_outer:last-child {
  padding-right: 0;
}
&#10;#gactpqlxev .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #5F5F5F;
  vertical-align: bottom;
...
&#10;#gactpqlxev .gt_spanner_row {
  border-bottom-style: hidden;
}
&#10;#gactpqlxev .gt_group_heading {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
&#10;#gactpqlxev .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #FFFFFF;
  font-size: 100%;
...
&#10;#gactpqlxev .gt_from_md > :first-child {
  margin-top: 0;
}
&#10;#gactpqlxev .gt_from_md > :last-child {
  margin-bottom: 0;
}
&#10;#gactpqlxev .gt_row {
  padding-top: 8px;
...
&#10;#gactpqlxev .gt_row_group_first td {
  border-top-width: 2px;
}
&#10;#gactpqlxev .gt_row_group_first th {
  border-top-width: 2px;
}
&#10;#gactpqlxev .gt_summary_row {
  color: #333333;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
...
&#10;#gactpqlxev .gt_first_summary_row {
  border-top-style: solid;
  border-top-color: #5F5F5F;
}
&#10;#gactpqlxev .gt_first_summary_row.thick {
  border-top-width: 2px;
}
&#10;#gactpqlxev .gt_last_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
&#10;#gactpqlxev .gt_grand_summary_row {
  color: #333333;
...
&#10;#gactpqlxev .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
&#10;#gactpqlxev .gt_last_grand_summary_row_top {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
&#10;#gactpqlxev .gt_striped {
  background-color: #F4F4F4;
}
&#10;#gactpqlxev .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #5F5F5F;
  border-bottom-style: solid;
...
&#10;#gactpqlxev .gt_font_normal {
  font-weight: normal;
}
&#10;#gactpqlxev .gt_font_bold {
  font-weight: bold;
}
&#10;#gactpqlxev .gt_font_italic {
  font-style: italic;
}
&#10;#gactpqlxev .gt_super {
  font-size: 65%;
}
&#10;#gactpqlxev .gt_footnote_marks {
  font-size: 75%;
  vertical-align: 0.4em;
  position: initial;
}
&#10;#gactpqlxev .gt_asterisk {
  font-size: 100%;
  vertical-align: 0;
}
&#10;#gactpqlxev .gt_indent_1 {
  text-indent: 5px;
}
&#10;#gactpqlxev .gt_indent_2 {
  text-indent: 10px;
}
&#10;#gactpqlxev .gt_indent_3 {
  text-indent: 15px;
}
&#10;#gactpqlxev .gt_indent_4 {
  text-indent: 20px;
}
&#10;#gactpqlxev .gt_indent_5 {
  text-indent: 25px;
}
&#10;#gactpqlxev .katex-display {
  display: inline-flex !important;
  margin-bottom: 0.75em !important;
}
&#10;#gactpqlxev div.Reactable > div.rt-table > div.rt-thead > div.rt-tr.rt-tr-group-header > div.rt-th-group:after {
...
<td headers="Industrial/Systems" class="gt_row gt_right">NA</td>
<td headers="Mechanical" class="gt_row gt_right">57.9</td></tr>
    <tr><td headers="People" class="gt_row gt_left gt_striped">International Male</td>
<td headers="Civil" class="gt_row gt_right gt_striped">56.7</td>
<td headers="Electrical" class="gt_row gt_right gt_striped">46.4</td>
...
<td headers="Electrical" class="gt_row gt_right gt_striped">40.0</td>
<td headers="Industrial/Systems" class="gt_row gt_right gt_striped">NA</td>
<td headers="Mechanical" class="gt_row gt_right gt_striped">51.2</td></tr>
    <tr><td headers="People" class="gt_row gt_left">White Female</td>
<td headers="Civil" class="gt_row gt_right">62.3</td>
<td headers="Electrical" class="gt_row gt_right">47.9</td>
<td headers="Industrial/Systems" class="gt_row gt_right">74.0</td>
<td headers="Mechanical" class="gt_row gt_right">63.2</td></tr>
    <tr><td headers="People" class="gt_row gt_left gt_striped">White Male</td>
<td headers="Civil" class="gt_row gt_right gt_striped">64.9</td>
<td headers="Electrical" class="gt_row gt_right gt_striped">52.0</td>
<td headers="Industrial/Systems" class="gt_row gt_right gt_striped">73.0</td>
<td headers="Mechanical" class="gt_row gt_right gt_striped">60.1</td></tr>
  </tbody>
  &#10;</table>
</div>
...
factors to support the ordering of rows and panels in the chart. The
calculated stickiness values by group—which determine the ordering—are
