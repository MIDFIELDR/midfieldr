...
knitr::opts_chunk$set(fig.path = "figures/art-090-")
...
We use the original source files copied earlier because some variables we want to use were removed when we applied `select_record_cols()`. 
...
[&#9665; Graduates](art-080-graduates.html) &nbsp;&nbsp; <a href="#top">&#9650; top of page</a> &nbsp;&nbsp; [Graduation rate &#9655;](art-100-grad-rate.html) 
