...
: Student Unit Records. Registrar's student-level data compiled by an institution and anonymized and curated by the MIDFIELD data steward. MIDFIELD data are organized into four tables---student, course, term, and degree. 
...
> *Caveat:*
>
> *The Student Unit Records included with midfieldr and midfielddata are practice data, not research data, suitable for practice working with SURs but not for drawing inferences about program attributes or student experiences.*
