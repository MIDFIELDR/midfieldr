...
With required packages installed (per the [main page](../index.html)), we start  with midfieldr by: 
...
The functions in midfieldr are briefly described in Table 2 with additional information available on the midfieldr [Reference](reference/index.html) page. Detailed examples of usage are distributed throughout the vignettes. Two of the helper functions are discussed in sections below.   
