...
In this vignette, we examine the practice data in [midfielddata](https://midfieldr.github.io/midfielddata/), an R data package containing a proportionate stratified sample of the MIDFIELD research data---longitudinal SURs for nearly 98,000 undergraduates at 12 institutions from  1987--2016 as summarized below. 

```{r echo = FALSE}
wrapr::build_frame(
  "Practice data table", "Each row is", "No. of rows", "No. of columns", "Memory" |
    "student", "a degree-seeking student", "97,640", "13", "19 Mb" |
    "course", "a student in a course", "3.5M", "12", "340 Mb" |
    "term", "a student in a term", "728,000", "13", "80 Mb" |
    "degree", "a student who graduates", "48,000", "5", "10.2 Mb"
) |>
...
wrapr::build_frame(
  "Function", "Action" |
    ...
    "prep_fye_mice()", "Construct and format FYE data for multivariate imputation"
) |>
