...
`student` is a table of `r var_students` student-related variables for the students in the sample, collected at the time they were admitted to their institutions as degree-seeking undergraduates. For the data dictionary, you can view the help page by running 
...
`course` is a table of `r var_courses` course-related variables for the students in the sample. For the data dictionary, you can view the help page by running 
...
`term` is a table of `r var_terms` term-related variables for the students in the sample. For the data dictionary, you can view the help page by running 
...
`degree` is a table of `r var_degrees` degree-related variables for the students in the sample. For the data dictionary, you can view the help page by running 
