...
link-citations: yes
resource_files:
  - ../man/figures/art-03-multiway-graphs-fig1-1.png
  - ../man/figures/art-03-multiway-graphs-fig2-1.png
---

```{r setup, include = FALSE}
knitr::opts_chunk$set(fig.path = "../man/figures/art-03-multiway-graphs-")
...
Many persistence metrics can be organized as *multiway data* in which there is is one quantitative variable and two categorical variables. As explained by  Cleveland [-@Cleveland:1993], 
...
To condition the categorical variables, we use `prepare_multiway()` to convert them to factors with levels ordered by the median response values. To see its help page, run
...
DT_med <- prepare_multiway(DT, details = TRUE)
