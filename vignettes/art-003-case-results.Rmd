...
Stickiness is the ratio of the number of graduates to the number of students ever enrolled in a program.

*Create a variable.*  &nbsp; "Stickiness" is the ratio of the number of graduates to the number of students ever enrolled in a program.  
...
The column `program_stick` determines the order of the programs in the chart; `people_stick` determines the order of the race/ethnicity/sex groupings; the values in `stickiness` are the quantitative values to be graphed. 
