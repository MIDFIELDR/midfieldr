...
- Compute stickiness (conclude with `study_stickiness`)
- Graph results
...
We will start with the case study program codes and names saved in the data set `study_programs`. You may review its help page by running
