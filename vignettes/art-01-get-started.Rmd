...
```{r}
# business
business <- subset_text(cip, pattern = "^52", select = "cip6")
```

The `pattern` argument gives the character string to be matched; the optional  `select` argument indicates columns to select from `cip`. 
...
```{r}
# engineering
engineering <- subset_text(cip, pattern = "^14", select = "cip6")
