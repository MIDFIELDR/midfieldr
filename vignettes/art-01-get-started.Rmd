...
We search `cip` for our program codes using `subset_text()`. You may view its help page by running
...
```{r}
# business
business <- subset_text(cip, keep_text = "^52", select = "cip6")
```
...
```{r}
# engineering
engineering <- subset_text(cip, keep_text = "^14", select = "cip6")
