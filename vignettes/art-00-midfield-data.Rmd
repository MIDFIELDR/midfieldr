...
```{r}
# pull the vector of unique IDs
id <- student[, unique(mcid)]
...
Each vignette concludes with its code chunks collected in a single, condensed script. Some users like to copy and paste the to an R script of their own.  
...
# load data from midfielddata into memory
data(student)
data(course)
data(term)
data(degree)
