...
```
/practice-midfieldr
    /data       # raw data from external sources 
    /results    # reproducible graphs and tables
...
Some packages have functions specialized for data frame summaries. Try these two and compare results. You may find one or the other useful in future data explorations. 
...
<br><br><br>
[*Multiway graphs and tables* &#5171;](art-01-multiway.html)  
<br><br>
