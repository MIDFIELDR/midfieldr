...
A proportionate stratified sample of these data (for practice) is available in [midfielddata](https://midfieldr.github.io/midfielddata/), an R data package with longitudinal SURs for nearly 98,000 undergraduates at 12 institutions from  1987--2016 organized in four data tables: 
...
In this vignette, we introduce the four data tables and briefly examine their contents. 

We suggest installing and loading the data.table package. While we use base R functions in the vignettes to reduce the cognitive load on new users, there are times when the data.table syntax offers advantages in brevity and speed.


### Outline

- Organize your midfieldr practice project 
...
Some of the code snippets in the midfieldr vignettes are written with relative file paths that assume the existence of this minimal structure. However, you may of course use any organization that suits your needs. 
