...
We suggest installing and loading the _data.table_ package. While we use base R functions in the vignettes to reduce the cognitive load on new users, there are times when the data.table syntax offers advantages in clarity and speed.
