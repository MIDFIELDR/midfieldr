...
Because a bloc is usually defined for specific programs, the final filter applied in gathering a bloc is often an *inner join* to filter by program labels, developed in [Programs](art-040-programs.html). Program labels are also one of the most commonly encountered grouping variables, with details given in [Groupings](art-090-groupings.html#program-labels). 
