...
How `fye_mi_prep()` works is outlined in an appendix below. 
...
### A. How `fye_mi_prep()` works 

The first operation in `fye_mi_prep()` is accessing `midfieldstudents` to extract all FYE students, yielding:
