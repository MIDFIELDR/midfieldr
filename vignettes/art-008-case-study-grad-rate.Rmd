...
The case study continues our tour of a typical workflow with student unit record data. This is a “big picture” development---functions are used without detailed explanations or development so that we can focus on the overall logic of the analysis. 
...
For a more detailed development and discussion of the midfieldr functions and methods used in this portion of the case study, see: 
