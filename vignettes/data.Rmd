...
The [midfieldterms](https://github.com/MIDFIELDR/midfieldterms) package provides `midfieldterms`, a tidy data frame with `r round(data_bits[["obs_term"]] / 1e+0, 0)`  observations and `r data_bits[["var_term"]]` academic term variables. Each observation is one term for one student. This dataset occupies `r round(data_bits[["size_term"]] / 1e+6, 1)` Mb of memory.  
