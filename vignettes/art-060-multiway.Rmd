...
# figures
knitr::opts_chunk$set(
  fig.path = "../man/figures/art-060-multiway-",
  fig.width = 6,
  fig.asp = 1 / 1.6,
  out.width = "70%",
  fig.align = "center"
...
S=\frac{N_g}{N_e}
$$
: We use stickiness in this vignette to illustrate a feature of the `order_multiway()` function. 
...
**Loading.** The data file `study_results` is included with midfieldr. 
