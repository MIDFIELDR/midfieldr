...
Converts the categorical variables to factors ordered by the quantitative variable. View the help page by running
...
: Data frame with multiway data in columns. Two additional numeric columns required when using the "percent" ordering method.
...
: Vector with the names (in quotes) of the numerator and denominator columns that produced the quantitative variable, required when order_by is "percent". 
