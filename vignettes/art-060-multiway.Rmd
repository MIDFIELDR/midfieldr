...
*Prepared data.* `study_results`, included with midfieldr, contains stickiness results as developed in [Case study: Results](art-003-case-results.html).
...
*Copying.* Prevents operations on `DT` from affecting `study_results` by reference  [@data.table-reference-semantics].
...
- **`method`** &nbsp; “median” (default) or “percent”, method of ordering the levels of the categories. If used, argument to be used by name.
