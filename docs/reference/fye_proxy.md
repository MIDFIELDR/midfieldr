...
provided for all students in the midfielddata practice data who ever
enroll in FYE.
...
`data.table` with 5789 rows and 2 columns keyed by student ID:
...
programs and a multiple imputation suitable for categorical variables
using the mice package. The predictor variables are institution, race,
and sex. The estimated variable is the 6-digit CIP code of a
