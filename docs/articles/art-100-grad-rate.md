...
#>   ---                       
#> 4079: MCID3112619118      EE
#> 4080: MCID3112619484      EE
#> 4081: MCID3112619666      ME
```
...
#>   ---                                 
#> 5870: MCID3112617717      ME graduates
#> 5871: MCID3112618976      ME graduates
#> 5872: MCID3112619484      EE graduates
```
...
#>   ---                                                      
#> 5870: MCID3112617717 International   Male      ME graduates
#> 5871: MCID3112618976         White   Male      ME graduates
#> 5872: MCID3112619484         White   Male      EE graduates
```
...
#> ---                                             
#> 94:  starters      ME Other/Unknown   Male    52
#> 95:  starters      ME         White Female   141
#> 96:  starters      ME         White   Male  1226
```
...
#>  1:      CE         Asian Female         4        8
#>  2:      CE         Asian   Male         9       17
#>  3:      CE         Black Female         1        5
#> ---                                                
#> 49:      ME Other/Unknown   Male        24       52
#> 50:      ME         White Female        71      141
#> 51:      ME         White   Male       567     1226
```
...
#>  1:      CE         Asian Female         4        8  50.0
#>  2:      CE         Asian   Male         9       17  52.9
#>  3:      CE         Black Female         1        5  20.0
#> ---                                                      
#> 49:      ME Other/Unknown   Male        24       52  46.2
#> 50:      ME         White Female        71      141  50.4
#> 51:      ME         White   Male       567     1226  46.2
```
...
#> ---                                                      
#> 25:      ME Other/Unknown   Male        24       52  46.2
#> 26:      ME         White Female        71      141  50.4
#> 27:      ME         White   Male       567     1226  46.2
```
...
#> ---                                                         
#> 25: Mechanical Other/Unknown   Male        24       52  46.2
#> 26: Mechanical         White Female        71      141  50.4
#> 27: Mechanical         White   Male       567     1226  46.2
```
...
#>  1:      Civil           Asian Male         9       17  52.9           46.3
#>  2:      Civil        Hispanic Male        10       36  27.8           46.3
#>  3:      Civil International Female         6       12  50.0           46.3
#> ---                                                                        
#> 25: Mechanical   Other/Unknown Male        24       52  46.2           46.6
#> 26: Mechanical         White Female        71      141  50.4           46.6
#> 27: Mechanical           White Male       567     1226  46.2           46.6
#>     people_metric
#>             <num>
#>  1:          47.2
#>  2:          33.1
...
#>  1:       Asian Female    NA       31.2                 NA         NA
#>  2:         Asian Male  52.9       39.3               42.9       57.1
#>  3:         Black Male    NA       20.7                 NA       39.1
#> ---                                                                  
#>  8: Other/Unknown Male  25.0       32.1                 NA       46.2
#>  9:       White Female  46.5       42.5               38.8       50.4
#> 10:         White Male  47.5       41.5               48.3       46.2
```
...
| People               | Civil | Electrical | Industrial/Systems | Mechanical |
|----------------------|-------|------------|--------------------|------------|
| Asian Female         | NA    | 31.2       | NA                 | NA         |
| Asian Male           | 52.9  | 39.3       | 42.9               | 57.1       |
| Black Male           | NA    | 20.7       | NA                 | 39.1       |
| Hispanic Female      | NA    | NA         | NA                 | 71.4       |
| Hispanic Male        | 27.8  | 32.4       | NA                 | 37.8       |
| International Female | 50.0  | NA         | NA                 | NA         |
| International Male   | 50.0  | 39.4       | 40.0               | 43.1       |
| Other/Unknown Male   | 25.0  | 32.1       | NA                 | 46.2       |
| White Female         | 46.5  | 42.5       | 38.8               | 50.4       |
| White Male           | 47.5  | 41.5       | 48.3               | 46.2       |
