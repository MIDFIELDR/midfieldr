...
interpret the results. Relevant functions:
...
data_sufficiency(dframe, # requires mcid, entry_term, timely_term
  midf_table = term
) # requires mcid, term, institution
```
...
***Example 3.*** Exemplifies “Student A” in Figure 1 or Figure 2.
...
***Example 4.*** Exemplifies “Student B” in Figure 1.
...
***Example 5.*** Exemplifies “Student C” in Figure 2.
