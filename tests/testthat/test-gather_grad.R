...
test_that("Reference data can have different column names", {
	expect_equal(
		gather_grad("030506", reference = ref1)[["id"]],
		gather_grad("030506", reference = ref2, id = "altID", cip6 = "altCIP6")[["altID"]]
	)
	expect_equal(
		gather_grad("030506", reference = subset_degrees)[["cip6"]],
		gather_grad("030506", reference = ref2, id = "altID", cip6 = "altCIP6")[["altCIP6"]]
	)
