#' @importFrom ggplot2 scale_x_log10 theme_minimal theme element_text element_rect element_line element_blank unit rel
...
#' \describe{
#'
#' \item{\code{expon_scale_x_log10()}}{Applies the usual \code{scale_x_log10()} function with the scale marked with powers of ten in exponential form and the logarithmic minor grid lines shown.}
#'
...
theme_minimal(base_family = "sans") +
	theme(
		...
		panel.border    = element_rect(size = 0.4, colour = rcb("pale_Gray"), fill = NA),
