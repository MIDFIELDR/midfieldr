...
#'
#' If sex and race variables are already present, the function returns the unchanged data frame and a message.
#'
#' @param df A data frame of student attributes that includes the variable \code{ID}.
#'
#' @return The incoming data frame plus three new columns \code{sex}, \code{race}, and the combined string \code{race_sex}, joined by student ID. Other columns are unaffected.
#'
#' @export
