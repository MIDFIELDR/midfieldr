...
#'
#' @param .cip A subset of the midfieldr \code{cip} data frame.
#'
...
#' y <- cip_label(x, program = "cip2name")
#' @export
cip_label <- function(.cip, program = NULL) {

  # .cip must match midfieldr cip data structure
  stopifnot(identical(
