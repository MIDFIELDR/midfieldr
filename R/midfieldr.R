...
#'
#'A package for investigating a sample from the MIDFIELD database, a dataset compiled from registrar's student records from participating US universities. The sample data include demographic, term, course, and degree information for 165,000 undergraduate students from 1990 to 2016.
#'
#' The Multi-Institution Database for Investigating Engineering Longitudinal Development (MIDFIELD) was started with longitudinal studies of engineering students in mind (the "E" in MIDFIELD). However, the data comprise complete registrar's student records---any academic program at those institutions can be studied.
#'
#' @section Data:
