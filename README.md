...
package you can install from GitHub.
...
We illustrate usage with a 351-student sample that loads with midfieldr.
...
# Data frame of IDs for refining the population
DT <- term[, .(mcid)]
DT <- unique(DT)
