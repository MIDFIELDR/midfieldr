...
# Initial population is set of IDs labeled "include"
...
look_at(term)
#> Classes 'data.table' and 'data.frame':   1347 obs. of  13 variables:
...
look_at(term)
#> Classes 'data.table' and 'data.frame':   1347 obs. of  15 variables:
#>  $ mcid               : chr  "MCID3111198701" "MCID3111198701" "MCID311120892"..
#>  $ term               : chr  "19891" "19893" "19891" "19893" ...
#>  $ cip6               : chr  "240102" "520301" "240102" "140102" ...
#>  $ institution        : chr  "Institution J" "Institution J" "Institution J" "..
